...
with st.sidebar.expander( "What do these settings mean?"):
    ...
    **Apply Feature Scaling:**
    Standardizes numeric features so they have mean 0 and variance 1. 
    Important for distance-based models like KNN and models sensitive to feature magnitude.
